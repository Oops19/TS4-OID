...
class DcFunction:
    ...
    F_LOWER_GENITAL = 'dc_lower_genital'
    ...
    F_BREASTS_MILKED = 'dc_breasts_milked'  # optionally append (3.0) to specify a multiplier for the number of milked bottles (DD setting)
    F_PENIS_MILKED = 'dc_penis_milked'  # optionally append (1.0) to specify a multiplier for the number of milked bottles (DD setting)
    F_PENIS_ORGASM = 'dc_penis_orgasm'  # optionally append (1.0) to specify a multiplier for the lost cum per orgasm (DD setting)
    ...
    F_AROUSAL = 'dc_arousal'  # append(n.m) to multiply the current arousal (0=reset)
    F_ORGASM = 'dc_orgasm'  # append(n.m) to multiply the current orgasm (0=reset)
    '''
    ...
    F_UNDRESS_NEXT = 'dc_undress_next'